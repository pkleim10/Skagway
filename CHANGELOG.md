...
- **Fun Component** — Experimental Settings-like chrome playground (sidebar with hide control, Search, and category list; content cards) opened from the Fun Component menu item; separate from Settings.
