...
- **Fun Component** — Experimental Settings-like chrome playground (sidebar with Search and categories; content cards with multi-row sample settings and inset separators) opened from the Fun Component menu item; separate from Settings.
